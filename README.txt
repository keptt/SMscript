...
What for:
SMscript (short for Send Mails Script) is created to automataize your mailing routine. It's made exclusively for sending out emails weather
for work related or your own shady purposes

How to use:
To send your emails using that script open smconfig.txt change its contents in respective blocks (blocks starts 
